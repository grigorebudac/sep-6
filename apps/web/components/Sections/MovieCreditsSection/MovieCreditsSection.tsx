          ...
          <Styles.List>
            {props.credits?.cast
              ...
              .map((castMember, index) => (
                <Link href={`?personId=${castMember.id}`} key={index}>
                  <a>
                    <Styles.ListItem>{castMember.name}</Styles.ListItem>
                  </a>
                </Link>
              ))}
          </Styles.List>
          ...
          <Styles.List>
            {props.credits?.crew
              ...
              .map((crewMember, index) => (
                <Link href={`?personId=${crewMember.id}`} key={index}>
                  <a>
                    <Styles.ListItem>{crewMember.name}</Styles.ListItem>
                  </a>
                </Link>
              ))}
          </Styles.List>
